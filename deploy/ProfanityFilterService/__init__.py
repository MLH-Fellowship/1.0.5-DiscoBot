...
__VERSION__ = "20200928001827_EFD1C3"

__module_path = os.path.abspath(os.path.dirname(__file__))

ProfanityFilterService = saved_bundle.load_bento_service_class(__module_path)
...
__all__ = ['__version__', 'ProfanityFilterService', 'load']
